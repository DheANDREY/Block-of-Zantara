...
namespace EasyTransition
{
    ...
    {        
        ...
        {
            transitionSettings = GameObject.FindGameObjectWithTag("transition").GetComponent<DemoLoadScene>();
        ...
        {
            Transition(transitionSettings.transition, transitionSettings.startDelay);
        }
    }
